...
const RecentOrders = () => {
  ...
  const orders = [
    ...
    { id: '#1238', product: 'USB-C Hub', customer: 'David Wilson', date: 'Apr 13, 2024', status: 'Processing', amount: '$79' },
     {id: '#1122', product:'Usb-C Hub', customer:'David Wilson', date:'Apr 12, 2025', status:'Processing', amount:'$79'},
    {id:'#1122', product:'Usb-c hub', customer:'David Wilson', date:'Ape 12,'}
  ];
